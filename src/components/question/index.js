  ...
  return (
    <div className="question">
      <div className="question-image-holder">
        <img src={question.image.downloadUrl} alt={question} />
      </div>
      <section>
        ...
        {question.options.map((option, index) => {
            return (
                ...
                className={`question-option ${answered && (isCorrect(option) && "correct")} ${selectedOption === option && !isCorrect(option) && "wrong"}`}
                >
                    <span>
